...
class EditUser extends Component {
    ...
    render() {
        ...
        const {_id, name, firstSurname, secondSurname, idCard, email, role, cellPhoneNumber, collegeCareer } = this.props.user;
                ...
                <div className="table-wrapper">
                    ...
                    <form className="my-4" onSubmit={this.saveValues}>
                            ...
                            <React.Fragment>
                                <div className="row d-flex justify-content-around">
                                    <div className="col-md-5">
                                        <div className="form-group">
                                            <label for="ci">Ci:</label>
                                            <input id="ci" type="text" className="form-control" placeholder="Ci" defaultValue={idCard} disabled />
                                        </div>
                                    </div>
                                    <div className="col-md-5">
                                        <div className="form-group">
                                            <label for="name">Nombre:</label>
                                            <input id="name" type="text" className="form-control" placeholder="Nombre" defaultValue={name} disabled />
                                        </div>
                                    </div>
                                </div>
                                <div className="row d-flex justify-content-around">
                                    <div className="col-md-5">
                                        <div className="form-group">
                                            <label for="firstSurname">Apellido Paterno:</label>
                                            <input id="firstSurname" type="text" className="form-control" placeholder="Apellido paterno" defaultValue={firstSurname} disabled />
                                        </div>
                                    </div>
                                    <div className="col-md-5">
                                        <div className="form-group">
                                            <label for="secondSurname">Apellido Materno:</label>
                                            <input id="secondSurname" type="text" className="form-control" placeholder="Apellido materno" defaultValue={secondSurname} disabled />
                                        </div>
                                    </div>
                                </div>
                            </React.Fragment>
                        ...
                        <div className="row d-flex justify-content-around">
                            ...
                            <div className="col-md-5">
                                <div className="form-group">
                                    <label for="collegeCareer">Carrera:</label>
                        ...
                        {this.state.changePassword === true ?
                            ...
                            <div className="row d-flex justify-content-around">
                                <div className="col-md-5">
                                    <button type="button" id="changePassword" onClick={this.changePassword} className="btn btn-warning ml-0">Cambiar contraseña</button>
                                </div>
                                <div className="col-md-5" />
                            </div>
                        }
                        ...
                        <div className="d-flex justify-content-center">
                            <Link className="btn btn-warning" to={"/users"}>Cancelar</Link>

                            <button type="submit" class="btn btn-blue">Guardar cambios</button>
                        </div>
                    </form>
                </div>
                {this.state.auth.getUser().role==="Administrador" && this.state.auth.getUser()._id===_id ? null :
                    <button type="submit" onClick={this.confirmDelete} class="btn btn-danger">Eliminar cuenta</button>
                }
            </div>
